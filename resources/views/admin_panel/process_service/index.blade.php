        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-8 col-auto">
                    <h3 class="page-title">{{ __('common.car_form') }}</h3>
                </div>
                <div class="col-sm-4 col btn-add-end">
                    <a href="{{route('admin-panel.process-service.save')}}" class="btn btnColor float-end mt-2">{{ __('admin.add') }} {{ __('admin.process') }}</a>
                </div>
            </div>
        </div>
...
@push('footer')
    ...
    <script>
        ...
        var ajax_url = "{!! route('admin-panel.process-service.index') !!}";
