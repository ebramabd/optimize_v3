        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-8 col-auto">
                    <h3 class="page-title">{{ __('common.subscriptions') }}</h3>
                </div>
                <div class="col-sm-4 col btn-add-end">
                    <a href="{{route('admin-panel.subscriptions.save')}}" class="btn btnColor float-end mt-2">{{ __('admin.add') }} {{ __('admin.subscription') }}</a>
                </div>
            </div>
        </div>
            ...
            <div class="card-body pt-0">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5 ajax-data-table">
                    ...
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">{{ __('admin.period') }}</th>
...
@push('footer')
    ...
    <script>
        ...
        var ajax_url = "{!! route('admin-panel.subscriptions.index') !!}";
