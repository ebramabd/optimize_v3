    ...
    <div class="p-7">
        ...
        <div class="card p-4 mb-4">
            <div class="home-subscription d-flex align-items-end">
                ...
                <h5 class="service-h5" style="margin-bottom: 3px">{{ __('common.system_administrators') }}</h5>
            </div>

            <div class="p-8">
                <a  href="{{ route('companies.setting.administrator.add') }}" class="link-box">
                    ...
                    @isset($administrators)
                        @foreach($administrators as $administrator)
                            <div class="branch-item p-2 d-flex align-items-center justify-content-between">
                                <h5 class="mb-0 fw-normal">{{$administrator->administrator_name}}</h5>
                                <a href="{{route('companies.setting.company.edit.administrator' , $administrator->id)}}"
